...
class Array(HAGLType):
    ...
    def construct(self, gym_value: gym.spaces.Tuple, template_values):
        ...
        assert t_elements_count == len(gym_value), "Got Gymnasium array with number of elements different from the specified one"
    ...
    def deconstruct(self, hagl_value, template_values):
        ...
        assert t_elements_count == len(hagl_value), "Got HAGL array with number of elements different from the specified one"
